...
namespace library
{
    ...
    class book
    {
        ...
        public:
            book();
            book(const std::string& t, const std::string& a, const std::string& i, const copyright_date& cd, const genre& g);
            ~book();
...
std::ostream& operator<<(std::ostream& os, const library::book& book); // I added this since exercise 5